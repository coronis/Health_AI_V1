...
HealthCoachAI is committed to implementing security and privacy by design across
all aspects of our application. This document outlines our comprehensive
security and privacy framework aligned with OWASP ASVS controls and global
privacy regulations.
...
We implement security controls based on OWASP Application Security Verification
Standard (ASVS) Level 2, with Level 3 controls for critical components handling
health data.
...
We maintain a responsible disclosure program with appropriate rewards for valid
security findings.
...
This document is reviewed quarterly and updated as needed to reflect changes in
our security posture and regulatory requirements.
