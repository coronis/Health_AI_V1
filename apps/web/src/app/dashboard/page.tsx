...
export default function Dashboard() {
  return (
    <div className='p-6 lg:p-8'>
      {/* Header */}
      <div className='mb-8'>
        <h1 className='text-2xl font-bold text-gray-900 font-display'>Good morning, Alex! 👋</h1>
            ...
            {todaysPlan.map((item, index) => (
              ...
              >
                ...
                <div className='text-right'>
                  ...
                  {item.calories && <p className='text-sm text-gray-600'>{item.calories} cal</p>}
                </div>
              </div>
            ))}
          </div>
          ...
          <div className='flex items-start space-x-3'>
            ...
            <div>
              <h3 className='font-medium text-primary-900'>
                Great progress on your protein intake!
              </h3>
              <p className='text-primary-700 text-sm mt-1'>
                You&apos;ve increased your protein consumption by 15% this week. Your muscle
                recovery should improve. Consider adding a post-workout protein shake for optimal
                results.
              </p>
