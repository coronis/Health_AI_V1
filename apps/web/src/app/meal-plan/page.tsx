...
export default function MealPlanPage() {
  ...
  const [, { execute: generateMealPlan }] = useApiCall(mealPlanningService.generateMealPlan);

  // Swap meal functionality
  const [swapState, { execute: swapMeal }] = useApiCall(mealPlanningService.swapMeal);

  // Apply meal swap
  const [, { execute: applyMealSwap }] = useApiCall(mealPlanningService.applyMealSwap);
  ...
  // Keep function available for future UI components
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const mealSwapHandler = handleApplySwap;
    ...
    <div className='p-6 lg:p-8'>
      ...
      <div className='mb-8'>
        <div className='flex justify-between items-start'>
          <div>
            <h1 className='text-2xl font-bold text-gray-900 font-display mb-2'>Weekly Meal Plan</h1>
            <p className='text-gray-600'>
                    ...
                    <div className='grid grid-cols-2 gap-3 text-sm'>
                      ...
                      {meal.nutrition.fiber && (
                        <div>
                          ...
                          <span className='font-medium text-gray-900 ml-1'>
                            {Math.round(meal.nutrition.fiber)}g
                          </span>
                        </div>
                      )}
