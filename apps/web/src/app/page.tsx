...
const features = [
  {
    ...
    description:
      'Personalized nutrition plans based on your health reports, preferences, and goals.',
    icon: ClipboardDocumentListIcon,
  },
  {
    name: 'Health Report Analysis',
    description:
      'Upload blood tests and get AI-powered insights with personalized recommendations.',
    icon: BeakerIcon,
  },
  {
    name: 'Fitness Planning',
    description:
      'Smart workout plans adapted to your fitness level, goals, and available equipment.',
    icon: HeartIcon,
  },
  {
        ...
        <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
          ...
          <div className='text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-600'>
              Transform your health with AI-powered nutrition, fitness planning, and health report
              analysis. Get personalized recommendations based on your unique health profile and
              goals.
            </p>
        ...
        <div className='px-6 py-24 sm:px-6 sm:py-32 lg:px-8'>
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <p className='mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600'>
              Start your personalized health journey today. Get AI-powered insights, meal plans, and
              fitness coaching tailored just for you.
            </p>
            <div className='mt-10 flex items-center justify-center gap-x-6'>
              <Link
                href='/dashboard'
              ...
              <Link
                href='/auth/login'
                className='inline-flex items-center justify-center rounded-lg px-4 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-primary-500'
              >
                Sign In
              </Link>
            </div>
