...
export default function ChatPage() {
  ...
  // Send message
  const [messageState, { execute: sendMessage }] = useApiCall(chatService.sendMessage);

  // Create session
  const [createSessionState, { execute: createSession }] = useApiCall(chatService.createSession);
    ...
    <div className='flex flex-col h-screen bg-gray-50'>
      ...
      <div className='bg-white border-b border-gray-200 px-6 py-4'>
        <div className='flex items-center justify-between'>
          <div>
            <h1 className='text-xl font-bold text-gray-900 font-display'>AI Health Coach</h1>
            <p className='text-sm text-gray-600'>Your personal nutrition and wellness assistant</p>
          </div>
          ...
          <div className='text-center py-8'>
            <div className='max-w-md mx-auto'>
              ...
              <p className='text-gray-600 mb-4'>
                I&apos;m here to help with your nutrition, fitness, and health questions. Ask me
                anything about your wellness journey!
              </p>
        ...
        {messages.map(msg => (
          ...
          >
            ...
            >
              ...
              {msg.metadata?.domainClassification &&
                !msg.metadata.domainClassification.isInScope && (
                  <div className='mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded text-xs text-yellow-800'>
                    ⚠️ This question is outside my health expertise. I can only help with nutrition,
