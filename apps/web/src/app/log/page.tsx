...
export default function LogPage() {
  ...
  return (
    <div className='p-6 lg:p-8'>
      {/* Header */}
      <div className='mb-8'>
        <h1 className='text-2xl font-bold text-gray-900 font-display mb-2'>Food & Activity Log</h1>
        ...
        <>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 mb-8'>
            ...
            <div className='lg:col-span-2'>
              <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
                <h3 className='text-lg font-semibold text-gray-900 mb-4 font-display'>Quick Add</h3>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
            ...
            <div className='space-y-6'>
              <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
                <h3 className='text-lg font-semibold text-gray-900 mb-4 font-display'>Add Food</h3>
      ...
      {activeTab === 'water' && (
        <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
          <h3 className='text-lg font-semibold text-gray-900 mb-4 font-display'>Water Intake</h3>
          <div className='text-center py-12'>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex justify-center space-x-2'>
                <button className='px-4 py-2 bg-blue-100 text-blue-800 rounded-lg text-sm'>
                  +250ml
                </button>
                <button className='px-4 py-2 bg-blue-100 text-blue-800 rounded-lg text-sm'>
                  +500ml
      ...
      {activeTab === 'weight' && (
        <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
          <h3 className='text-lg font-semibold text-gray-900 mb-4 font-display'>Weight Tracking</h3>
          <div className='text-center py-12'>
      ...
      {activeTab === 'mood' && (
        <div className='bg-white rounded-xl shadow-sm border border-gray-200 p-6'>
          <h3 className='text-lg font-semibold text-gray-900 mb-4 font-display'>Mood & Energy</h3>
          <div className='text-center py-12'>
